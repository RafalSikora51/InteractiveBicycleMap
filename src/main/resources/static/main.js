...
var routes = [
    ...
    { path: 'segments/alljson', component: _segment_segment_component__WEBPACK_IMPORTED_MODULE_3__["SegmentComponent"] },
    { path: 'segments', component: _segment_segment_component__WEBPACK_IMPORTED_MODULE_3__["SegmentComponent"] },
    ...
    GoogleMapComponent.prototype.doDijkstraOnList = function () {
        ...
        if (this.pressedNodes.length <= 1) {
            ...
            this.segmentService.dijkstraOnList(this.paramArray)
                ...
                _this.markersToRemove[0].setIcon('/assets/greenpin.png');
                for (var i = 1; i < _this.markersToRemove.length - 1; i++) {
                    _this.markersToRemove[i].setIcon('/assets/redpin.png');
                }
                _this.markersToRemove[_this.markersToRemove.length - 1].setIcon('/assets/placeholder.png');
            });
            this.markers = [];
            this.pressedNodes = [];
            this.addressArray = [];
...
module.exports = __webpack_require__(/*! F:\Rafał\interactivemap\InteractiveMap-Angular\src\main.ts */"./src/main.ts");
